  ...
  return (
    <div className="bg-indigo-950 rounded-md overflow-hidden">
      ...
      <div className="p-6">
         ...
         <p className="text-sm font-semibold text-gray-200 text-opacity-70">{summary}</p>
         <div className="mt-4 mb-4 w-full h-[1.5px] bg-gray-400 opacity-45"></div>
         <div className="flex items-center justify-between">
            <h1 className="text-gray-300 text-sm font-bold">{date}</h1>
            <button className="text-base hover:text-rose-500 text-gray-200 underline font-semibold">Read More</button>
         </div>
      </div>
    </div>
  );
